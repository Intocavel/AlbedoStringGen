...
ERROR_MESSAGE = "Ops! Ocorreu uma exceção! \n\n**Error** : {} " \
            "\n\nPor favor, visite @lntocavel se esta mensagem não contiver nenhum " \
            "informações confidenciais e você se quiser denunciar isso como " \
            "esta mensagem de erro não está sendo registrada por nós!"
